      ...
      g.each(function(d, i) {
        ...
        d.forEach( function(datum, index){
          ...
          g.selectAll("svg").data(data).enter()
            ...
            // .attr("data-bs-toggle", function(d, i) {
            //   return "tooltip";
            // })
            .attr("title", function(d, i) {
              return datum.times[i].label ? datum.times[i].label : datum.label?datum.label:"undifined";
            })
          ...
          // add the label
          if (showLabel && hasLabel) { appendLabel(gParent, yAxisMapping, index, hasLabel, datum); }
