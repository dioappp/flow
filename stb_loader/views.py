...
def index(request):
    ...
    return render(request, 'stb_loader/index.html',{'jam':loop_times, 'stb':stb, 'ritase':tipe_ritase})
...
def timeline(request):
    ...
    maindata = LoaderStatus.objects.filter(date=date_pattern, hour=hour_pattern, unit__unit=unit_pattern).order_by('timeStart')
